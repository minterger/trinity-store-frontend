...
<template>
  <div class="w-full h-10">
    <div class="px-2 max-w-screen-lg mx-auto w-full h-full flex justify-end">
  ...
  <nav
    class="w-full h-16 border-t border-b backdrop-blur bg-slate-700 bg-opacity-30 border-slate-700"
  >
    <div
